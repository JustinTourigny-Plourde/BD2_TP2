...
from MaSuperFenetre import Ui_MainWindow
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def _charger_personnage(self):
        ...
        try:
            ...
            if isinstance(id_charge, int):
                ...
                self.comboBox_arme_2.setCurrentIndex(id_arme[1]['id'] -1)
                ...
                self.comboBox_discipline_1.setCurrentIndex(id_kai[0]['id'] -1)
                self.comboBox_discipline_2.setCurrentIndex(id_kai[1]['id'] -1)
                self.comboBox_discipline_3.setCurrentIndex(id_kai[2]['id'] -1)
                self.comboBox_discipline_4.setCurrentIndex(id_kai[3]['id'] -1)
                self.comboBox_discipline_5.setCurrentIndex(id_kai[4]['id'] -1)
    ...
    def _afficher_arme(self):
        try:
            ...
            for arme in armes:
                ...
                self.comboBox_arme_2.addItem(arme['nom'])
    ...
    def _sup_arme(self):
        try:
            ...
            arme_2 = self.comboBox_arme_2.currentIndex() +1
    ...
    def _afficher_kai(self):
        try:
            ...
            for kai in kais:
                self.comboBox_discipline_1.addItem(kai['nom'])
                self.comboBox_discipline_2.addItem(kai['nom'])
                self.comboBox_discipline_3.addItem(kai['nom'])
                self.comboBox_discipline_4.addItem(kai['nom'])
                self.comboBox_discipline_5.addItem(kai['nom'])
    ...
    def _sup_kai(self):
        try:
            ...
            discipline_1 = self.comboBox_discipline_1.currentIndex() +1
            discipline_2 = self.comboBox_discipline_2.currentIndex() +1
            discipline_3 = self.comboBox_discipline_3.currentIndex() +1
            discipline_4 = self.comboBox_discipline_4.currentIndex() +1
            discipline_5 = self.comboBox_discipline_5.currentIndex() +1

            param = {'id_personnage' : id_sauvegarde, 'discipline_1': discipline_1, 'discipline_2': discipline_2, 'discipline_3': discipline_3, 'discipline_4': discipline_4, 'discipline_5': discipline_5}
    ...
    def _change_kai(self):
        try:
            ...
            requete = "INSERT INTO discipline_personnage VALUES ( %(discipline_1)s, %(id_personnage)s, 1), (%(discipline_2)s, %(id_personnage)s, 2), (%(discipline_3)s, %(id_personnage)s, 3), (%(discipline_4)s, %(id_personnage)s, 4), (%(discipline_5)s, %(id_personnage)s, 5);"
            cursor.execute(requete, param)
